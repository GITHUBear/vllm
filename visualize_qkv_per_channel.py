...
with h5py.File(data_path, 'r') as data:
    for j in range(layer_num):
        ...
        for doc_idx, (doc_s_id, doc_e_id) in enumerate(doc_split_pos):
            ...
            all_k = k_tensor[:, 0, :].cpu()
            plt.plot(all_k[:, 50], label='channel 20', color='blue', marker='o', markersize=3)
            ...
            plt.savefig(f"./per_channel_all1.png", dpi=150, bbox_inches='tight')
            # plt.close()
